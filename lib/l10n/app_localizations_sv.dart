...
class AppLocalizationsSv extends AppLocalizations {
  ...
  @override
  String get startLoginPersonal => 'Logga in - privat';

  @override
  String get businessLoginTitle => 'Företagsinloggning';

  @override
  String get businessLoginBody =>
      'Licenser köps separat. Använd företagets inloggningslänk eller SSO. Behöver du hjälp, kontakta din administratör.';
  ...
  String get termsBody =>
      'ANVÄNDARVILLKOR — SERA\n\nVersion: 2025-11-03\nGäller för: SERA-appen och tillhörande tjänster (“Tjänsten”)\nLeverantör: SimlingGroup SERA\nAdress: Ullevivägen 45, 746 51 Bålsta\nKontakt: support@sera.chat\n\n1. Om Tjänsten\n\nSERA är en felsöknings- och serviceassistent för maskiner/utrustning. Appen erbjuder chattbaserad vägledning med säkerhetsfokus och kan visa källor/disclaimers. Tjänsten kan integrera tredjeparts AI-leverantörer och ett eget kuraterat kunskapsbibliotek (“SERA:s bibliotek”) för att förbättra svarens kvalitet.\n\nViktig säkerhetsnotis: SERA ersätter inte tillverkarens manualer, utbildning eller certifierad fackkunskap. Följ alltid lokala säkerhetsregler, låsning/avstängning (LOTO) och tillverkarens instruktioner. Använd Tjänsten på eget ansvar.\n\n2. Behörighet\n\nDu behöver vara:\n• Minst 16 år (eller högre ålder enligt lokal lag), och\n• behörig att ingå avtal.\nFöretagsanvändare intygar att de använder Tjänsten inom ramen för sin arbetsgivare/organisation och följer interna policyer.\n\n3. Konto och åtkomst\n• Privatpersoner: Kan köpa prenumeration i appen via App Store/Google Play.\n• Företag: Får åtkomst via företagslicens (avtal) och inloggning (t.ex. SSO/e-post).\nDu ansvarar för korrekt och uppdaterad kontoinformation samt för att skydda inloggningsuppgifter.\n\n4. Acceptabel användning (förbjudet beteende)\n\nDu får inte:\n• kringgå säkerhetsfunktioner eller belasta Tjänsten orimligt (t.ex. scraping, rate-limit-bypass),\n• använda Tjänsten i olagligt syfte, dela skadligt innehåll eller kränka andras rättigheter,\n• försöka återskapa, dekompilera eller reverse-engineera Tjänstens system, modeller eller bibliotek.\n\n5. AI-svar och SERA:s bibliotek\n\nNär du ställer en fråga skickas relevant innehåll (inkl. valda märke/modell/år) till vår server/proxy. Servern kan:\n1. Söka i SERA:s bibliotek (manualer, servicebulletiner m.m. som vi har rätt att använda),\n2. vidarebefordra minsta nödvändiga utdrag + din fråga till en tredjeparts AI-leverantör,\n3. sammanställa svaret till dig, ofta med källhänvisningar.\n\nVi konfigurerar leverantören så att data inte används för generell modellträning där sådana kontroller finns. Loggar kan behållas kort tid för säkerhet/missbruksdetektion. All kommunikation sker över HTTPS. Se vidare i Integritetspolicyn.\n\n6. Integritet och data\n\nAll personuppgiftsbehandling beskrivs i vår Integritetspolicy (Privacy Policy). Den är en del av dessa villkor.\n\n7. Immateriella rättigheter\n\nSERA-appen, grafiska element (inkl. logotyper) och SERA:s bibliotek ägs av Simlingroup eller våra licensgivare. Du får en begränsad, icke-exklusiv, icke-överlåtbar licens att använda Tjänsten enligt dessa villkor. All annan användning kräver vårt skriftliga medgivande.\n\n8. Innehåll från användare\n\nOm du laddar upp text/bilder/loggar i Tjänsten ger du oss en global, icke-exklusiv licens att behandla detta endast i syfte att leverera Tjänsten (inkl. felsökning, support och säkerhet). Du ansvarar för att du har rätt att dela materialet och att det inte bryter mot lag eller tredje mans rätt.\n\n9. Beta-funktioner\n\nMärkta “Beta” kan vara ofärdiga och ändras eller avvecklas utan föregående meddelande. Du använder Beta på egen risk.\n\n10. Avbrott och ändringar\n\nVi kan göra schemalagt underhåll, uppdatera funktioner eller ändra Tjänsten. Vid större ändringar försöker vi informera i förväg.\n\n11. Ansvarsbegränsning och friskrivning\n\nTjänsten tillhandahålls ”i befintligt skick”. I den utsträckning lagen tillåter friskriver vi oss från indirekta skador (t.ex. produktionsbortfall, följdskador, dataförlust). Vår sammanlagda ansvarsnivå är begränsad till vad du betalat de senaste 12 månaderna för Tjänsten (gäller inte när tvingande konsumentlag ger dig högre skydd).\n\n12. Konsumenträtt (gäller privatpersoner)\n\nIngenting i dessa villkor begränsar dina tvingande rättigheter enligt gällande konsumentlagstiftning (t.ex. distansavtalslagen i Sverige). Prenumerationer som köps via App Store/Google Play hanteras enligt respektive butiks villkor och återbetalningsprocesser.\n\n13. Uppsägning och avstängning\n\nDu kan sluta använda Tjänsten när som helst. Vi kan stänga av eller säga upp åtkomsten vid brott mot villkoren, risk för säkerhet/missbruk eller utebliven betalning. För privatprenumeration: se Prenumerationsvillkor.\n\n14. Ändringar av villkor\n\nVi kan uppdatera dessa villkor. Vid väsentliga ändringar informerar vi i appen eller via e-post. Fortsatt användning efter ikraftträdandet innebär att du godtar ändringarna.\n\n15. Tillämplig lag och tvist\n\nSvensk lag gäller. Tvist avgörs av svensk allmän domstol med [valfri: Stockholms tingsrätt] som första instans, om inte tvingande konsumenträtt anger annat.\n\n16. Kontakt\n\nFrågor om Tjänsten eller villkoren: support@sera.chat';

  @override
  String get subscriptionTitle => 'Prenumerationsvillkor';

  @override
  String get subscriptionBody =>
      'PRENUMERATIONSVILLKOR — SERA\\n\\nVersion: 2025-11-03\\nGäller privata prenumerationer via App Store/Google Play och företagslicenser via avtal.\\n\\n1. Omfattning\\n\\nDessa villkor reglerar betalning, förnyelse, avbokning och återbetalning för:\\n• Privat prenumeration (IAP): köps i appen via App Store eller Google Play.\\n• Företagslicens: tecknas utanför appen via avtal/faktura (per organisation och/eller per användare).\\n\\n2. Planer och priser\\n• Privat: månadsprenumeration, preliminärt 29 kr/månad (inkl. moms). Det exakta priset visas i App Store/Google Play för din region.\\n• Företag: plan/pris enligt offert eller prislista (t.ex. per seat eller paketnivåer). Minimiavgift och volymrabatter kan gälla.\\n\\nVi kan ändra priser/planer framåt i tiden. För privatabonnemang följer vi App Store/Google Plays rutiner för prishöjningar (förhandsinfo + möjlighet att avböja).\\n\\n3. Betalning\\n• Privat (IAP): Betalning hanteras av App Store/Google Play med ditt butikskonto. Vi tar inte emot direktbetalning i appen för privatspåret.\\n• Företag: Faktura/Stripe enligt avtal (t.ex. 30 dagar netto). Försening kan medföra dröjsmålsränta och/eller avstängning.\\n\\n4. Period och förnyelse\\n• Prenumeration gäller kalendermånad från köptillfället och förnyas automatiskt tills du säger upp den.\\n• Företagslicenser löper enligt avtal (månad/år) och förnyas enligt avtalsvillkoren.\\n\\n5. Hantera/avsluta prenumeration\\n• iOS (App Store): Öppna Inställningar → ditt namn → Abonnemang → välj SERA → Avbryt prenumeration.\\n• Android (Google Play): Öppna Google Play → profil → Betalningar & prenumerationer → Prenumerationer → SERA → Avbryt.\\nUppsägning gäller från nästa period. Du har tillgång till slutet av aktuell betald period.\\n\\n6. Ångerrätt och återbetalning (konsument)\\n• Ångerrätt: I EU/SE kan digitala abonnemang ha 14 dagars ångerrätt. App Store/Google Play hanterar detta inom sina system.\\n• Om du samtycker till omedelbar leverans av digitalt innehåll kan ångerrätten helt/delvis påverkas enligt lag/butikernas villkor.\\n• Återbetalning: Begärs via App Store/Google Play. Vi gör normalt inga direkta återbetalningar för IAP-köp.\\n\\n7. Företag: säten/användare\\n• Licensen gäller för organisationen. Admin kan tilldela platser (seats) till användare.\\n• Du ansvarar för att endast auktoriserade användare nyttjar licensen och att inlogg delas enligt avtalet (inte mellan personer om inte tillåtet).\\n• Vi kan tillämpa rättvis användning och tekniska begränsningar (API-kvoter, samtidighet).\\n\\n8. Tillgång och avstängning\\n• Vid obetald faktura/otillåten användning kan tillgången begränsas eller stängas av.\\n• Om ditt butikskonto saknar aktiv prenumeration (privat) eller din org-licens löper ut (företag), kan Tjänsten upphöra att fungera tills betalning/avtal återaktiveras.\\n\\n9. Ändringar av prenumerationsvillkor\\n\\nVi kan uppdatera dessa villkor. Vid väsentliga ändringar informerar vi i appen/e-post och/eller via butikernas meddelanden. Fortsatt användning efter ikraftträdande innebär att du godtar ändringarna.\\n\\n10. Support och kontakt\\n• Teknisk support & fakturafrågor SimlinGroup: support@sera.chat\\n• IAP-köp (privat): Hanteras primärt via App Store/Google Play.\\n• Adress: Ullevivägen 45, 746 51 Bålsta';
